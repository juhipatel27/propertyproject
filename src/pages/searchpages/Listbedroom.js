...
import {ratedisplay} from "../../Actions/RateAction";
import {bedroomdisplay} from "../../Actions/BedroomAction";
...
class Listbedroom extends Component {
    constructor(props) {
        super(props)
        this.state = {
            bedroom: ''
    ...
    componentWillMount(){
        this.state.bedroom = this.props.navigation.state.params.bedroom1.bedroom;
        console.log(this.state.bedroom)
        const bedroom={
            bedroom:this.state.bedroom
        }
        bedroomdisplay(bedroom).then((res)=>{
            debugger;
